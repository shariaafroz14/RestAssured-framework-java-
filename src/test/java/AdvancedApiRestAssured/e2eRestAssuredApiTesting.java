package AdvancedApiRestAssured;
...
import com.testAutomation.Apitesting.tests.EndToEndAPITest;
...
public class e2eRestAssuredApiTesting extends  BaseTest{
		...
		public void e2eAPIRequest() {
			...
			try {
				String postAPIRequestBody = FileUtils.readFileToString(new File(FileNameConstant.POST_API_REQUEST_BODY),
						"UTF-8");
				String tokenAPIRequestBody = FileUtils.readFileToString(new File(FileNameConstant.TOKEN_API_REQUEST_BODY),
						"UTF-8");
