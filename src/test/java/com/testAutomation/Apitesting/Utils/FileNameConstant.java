...
public class FileNameConstant {
	...
	public class FileNameConstants {
		...
		public static final String POST_API_REQUEST_BODY_DYNAMIC = BASE_PATH+"postapirequestbodydynamic.txt";
	...
	public static final String PATCH_API_REQUEST_BODY = null;

	public static String PUT_API_REQUEST_BODY;
	public static String TOKEN_API_REQUEST_BODY;
	public static String POST_API_REQUEST_BODY;
